                ...
                <div class="col-md-4">
                    <div class="card-box h-100">
                        ...
                        <div class="card-body">
                            <div class="row ">
                                <div class="col-md-6">
                                    <h1 class="display-6 text-primary mb-2 pt-4 pb-1">3+ Years of Exprience</h1>
                                    <small class="d-block mb-3">In <br>ĂN BÁM BỐ MẸ.</small>
                                    <br>
                                    <br>
                                    <a href="https://github.com/AkamineHaruna" target="a_blank" class="btn btn-sm btn-primary">Visit Website</a>
                                </div>
                                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <div class="card-box h-100">
                        <div class="card-body">
                            <div class="row ">
                                <div class="card-header">
                                    <h4 class="card-title m-0">Visits of 2025</h4>
                                </div>
                                <div id="chart">
